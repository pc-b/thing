...
const SOURCE_DOMAIN = "https://www.wuxiaworld.com/"

export class WuxiaWorld extends Source {
    constructor(cheerio: CheerioAPI) {
        super(cheerio)
    }

    get version(): string { return '0.1.0' }
    get name(): string { return 'WuxiaWorld' }
    get description(): string { return 'WuxiaWorld' }
    get author(): string { return 'pcb' }
    get authorWebsite(): string { return 'WuxiaWorld' }
